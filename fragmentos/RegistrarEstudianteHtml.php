<div >
    ...
    <form method="post"  action="includes/RegistrarUsuario.php">
           ...
           <!-- <div class="form-group"><input type="text" name="idTipoDocumento" class="form-control"  placeholder="tipo documento" required /></div>-->
            ...
            <div class="form-group"><input type="text" name="programa" class="form-control" minlength="4" placeholder="Programa o Carrera" required /></div>
            <p>Fecha de nacimiento</p>
            <div class="form-group"><input style="" type="date" name="nacimiento" class="form-control"  placeholder="Fecha de Nacimiento" required /></div>

<!--input type="checkbox" name="terminos" value="Bike"> Aceptar <a href="fragmentos/terminos.php">terminos y condiciones</a><br--><br>
            <input type="submit" class="btn btn-submit" value="Registrarme"/>
        </form>
    </div>
</div>
<br><br><br><br>